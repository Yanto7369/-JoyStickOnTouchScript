...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty timeLimitWileDragging;
    ...
    protected virtual void OnEnable()
    {
        ...
        timeLimitWileDragging=serializedObject.FindProperty("TimeLimitWhileDragging");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(timeLimit, new GUIContent("Time Limit"," time limit"));
        EditorGUILayout.PropertyField(timeLimitWileDragging, new GUIContent("Time Limit While Dragging"," time limit while dragging"));
    }
